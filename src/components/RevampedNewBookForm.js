...
function RevampedNewBookForm(props) {
        ...
        .then((snapshot) => {
          ...
          imageRef
            ...
            .then((url) => {
              ...
              userBook["publishedDate"] = publishYear;
        ...
        <Controller
          ...
          render={({ onChange, onBlur, value }) => (
            <View
              style={{
                marginHorizontal: 10,
                marginBottom: errors.bookName ? 0 : 10,
              }}
            >
              <TextInput
        ...
        <Controller
          ...
          render={({ onChange, onBlur, value }) => (
            <View
              style={{
                marginHorizontal: 10,
                marginBottom: errors.authorName ? 0 : 10,
              }}
            >
              <TextInput
        ...
        <Controller
          ...
          render={({ onChange, onBlur, value }) => (
            <View
              style={{
                marginHorizontal: 10,
                marginBottom: errors.pageCount ? 0 : 10,
              }}
            >
              <TextInput
              ...
              {((errors.pageCount && errors.pageCount.type === "required") ||
          ...
          render={({ onChange, onBlur, value }) => (
            <View style={styles.inputMargin}>
              <TextInput
                ...
                value={value}
              ></TextInput>
              {errors.publishYear && errors.publishYear.type === "validate" && (
                <Text style={styles.errorMessage}>
                  Insert a valid publish year.
                </Text>
              )}
            </View>
          )}
...
export default RevampedNewBookForm;
